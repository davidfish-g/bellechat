...
def get_base_dir():
    # co-locate bellechat intermediates with other cached data in ~/.cache (by default)
    if os.environ.get("BELLECHAT_BASE_DIR"):
        bellechat_dir = os.environ.get("BELLECHAT_BASE_DIR")
    elif os.environ.get("NANOCHAT_BASE_DIR"):
        bellechat_dir = os.environ.get("NANOCHAT_BASE_DIR")
    else:
        home_dir = os.path.expanduser("~")
        cache_dir = os.path.join(home_dir, ".cache")
        bellechat_dir = os.path.join(cache_dir, "bellechat")
    os.makedirs(bellechat_dir, exist_ok=True)
    return bellechat_dir
